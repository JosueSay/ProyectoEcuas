...
temperatura_pred_nueva = modelo_enfriamiento(tiempo_pred, T0_ajustado_nuevo, k_ajustado_nuevo)

plt.figure(figsize=(10, 6))
plt.scatter(tiempo_nuevo, temperatura_nueva, color='blue', label='Datos Experimentales Nuevos')
plt.plot(tiempo_pred, temperatura_pred_nueva, color='red', label='Ajuste del Modelo con Nuevos Datos')
